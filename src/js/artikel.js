const articles = [
    {
        ...
        content: `
            ...
            <p class="mb-6">Meskipun sama-sama kunyit, kandungan di dalamnya memiliki konsentrasi yang berbeda. Ibu Kunyit menyimpan cadangan makanan utama bagi tanaman, sehingga ia memiliki konsentrasi <strong>Kurkuminoid</strong> dan <strong>Minyak Atsiri</strong> yang jauh lebih padat dibandingkan anak-anaknya.</p>
            
            <div class="border-l-4 border-emerald-600 pl-6 py-4 my-8 bg-emerald-50 rounded-r-xl">
                <p class="text-emerald-800 font-medium italic text-lg">"Ibu Kunyit adalah 'powerhouse'. Satu ruas biang bisa setara dengan 3-4 ruas jari kunyit biasa dalam hal potensi anti-inflamasi."</p>
            </div>
            ...
            <ul class="list-disc list-inside space-y-3 mb-6 ml-2 text-gray-700">
                <li><strong>Rasa Lebih Pekat & Tidak Langu:</strong> Biang kunyit memiliki rasa yang lebih "deep" dan earthy, serta aroma yang lebih harum, tidak selangu kunyit muda.</li>
                <li><strong>Warna Oranye Pekat:</strong> Warna ini bukan pewarna buatan. Ini adalah tanda tingginya kadar kurkumin, antioksidan alami yang ampuh meredakan peradangan.</li>
                <li><strong>Khasiat Lebih Cepat:</strong> Efektif untuk meredakan nyeri haid (kram perut) dan menetralkan asam lambung dengan lebih cepat.</li>
            </ul>
    ...
    },
    {
        ...
        content: `
            ...
            <div class="border-l-4 border-emerald-600 pl-6 py-4 my-8 bg-emerald-50 rounded-r-xl">
                <p class="text-emerald-800 font-medium italic text-lg">"Tidur yang berkualitas bukan soal memaksa mata terpejam lebih cepat. Ia tentang menciptakan kondisi di mana tubuh merasa cukup aman untuk benar-benar beristirahat."</p>
            </div>
            ...
            <ul class="list-disc list-inside space-y-3 mb-6 ml-2 text-gray-700">
                <li><strong>Bangun tidur tidak segar:</strong> Badan seperti butuh waktu lama untuk "loading".</li>
                <li><strong>Mood Swing Pagi Hari:</strong> Mudah marah atau emosi tidak stabil.</li>
                <li><strong>Brain Fog:</strong> Konsentrasi mudah buyar dan ingatan jangka pendek menurun (lupa naruh kunci, dll).</li>
                <li><strong>Mengantuk di jam tanggung:</strong> Rasa kantuk berat menyerang pukul 10-11 siang.</li>
            </ul>
    ...
    },
    {
        ...
        content: `
            ...
            <div class="border-l-4 border-emerald-600 pl-6 py-4 my-8 bg-emerald-50 rounded-r-xl">
                <p class="text-emerald-800 font-medium italic text-lg">"Micro-break bukanlah tentang berhenti bekerja, melainkan tentang menajamkan kembali 'kapak' sebelum kembali menebang pohon."</p>
            </div>
            ...
            <ul class="list-disc list-inside space-y-3 mb-6 ml-2 text-gray-700">
                <li><strong>Aturan 20-20-20:</strong> Setiap 20 menit, lihat objek sejauh 20 kaki (6 meter) selama 20 detik. Ini merelaksasi otot mata yang tegang.</li>
                <li><strong>Hydration Walk:</strong> Berdiri, jalan ke pantry, isi ulang botol air minum. Gerakan fisik melancarkan sirkulasi darah ke otak.</li>
                <li><strong>Teknik Pernapasan 4-7-8:</strong> Tarik napas 4 detik, tahan 7 detik, hembuskan 8 detik. Ini menurunkan hormon stres kortisol secara instan.</li>
            </ul>
    ...
    },
    {
        ...
        content: `
            ...
            <p class="mb-6">Secara medis, olahraga ringan justru sangat disarankan saat haid. Ketika kita berolahraga, tubuh melepaskan hormon <strong>Endorfin</strong>—senyawa kimia alami yang bertindak sebagai penghilang rasa sakit (painkiller) dan peningkat suasana hati. Ini adalah lawan alami dari Prostaglandin, zat yang menyebabkan kontraksi rahim (kram).</p>

            <div class="border-l-4 border-emerald-600 pl-6 py-4 my-8 bg-emerald-50 rounded-r-xl">
                <p class="text-emerald-800 font-medium italic text-lg">"Jangan forsir tubuh untuk mencetak rekor baru. Tujuannya adalah melancarkan sirkulasi darah, bukan membakar kalori maksimal."</p>
            </div>
            ...
            <ul class="list-disc list-inside space-y-3 mb-6 ml-2 text-gray-700">
                <li><strong>Yoga & Stretching:</strong> Pose seperti <em>Child's Pose</em> atau <em>Cat-Cow</em> sangat efektif meregangkan otot punggung bawah yang kaku.</li>
                <li><strong>Jalan Santai:</strong> Jalan pagi 15-20 menit cukup untuk memicu endorfin tanpa membuat tubuh stres.</li>
                <li><strong>Renang Santai:</strong> Tekanan air bisa memberikan efek pijatan lembut pada tubuh, meski pastikan kebersihan air terjaga.</li>
            </ul>

            <h3 class="text-2xl font-bold mb-4 text-black">Dukung dari Dalam</h3>
            <p class="mb-6">Selain gerak, asupan nutrisi juga penting. Hindari kafein berlebih yang bisa memperparah kram. Sebagai gantinya, minuman hangat yang mengandung <strong>Kunyit Asam</strong> sangat membantu karena sifat anti-inflamasi (pereda radang) dan antipiretik (pereda nyeri) alaminya.</p>
    ...
    },
    {
        ...
        content: `
            <p class="mb-6">Bekerja di kantor modern memang nyaman, tapi seringkali kita dihadapkan pada satu musuh tak kasat mata: <strong>Suhu AC Kutub Utara</strong>. Duduk diam selama 8 jam di ruangan bersuhu 18-20 derajat Celcius seringkali berujung pada kondisi khas orang Indonesia: Masuk Angin.</p>
            ...
            <ul class="list-disc list-inside space-y-3 mb-6 ml-2 text-gray-700">
                <li><strong>Teknik Layering:</strong> Selalu sediakan cardigan, jaket, atau syal di laci meja. Lindungi area leher dan punggung atas, karena area ini paling sensitif terhadap angin.</li>
                <li><strong>Jangan Tahan Buang Angin:</strong> Kedengarannya lucu, tapi menahan gas justru memperparah kembung. Izinlah ke toilet sebentar jika perlu.</li>
                <li><strong>Gerak Setiap Jam:</strong> Berdiri dan berjalanlah. Gerakan fisik membantu "mengocok" usus dan melancarkan aliran darah yang beku karena duduk.</li>
            </ul>

            <div class="border-l-4 border-emerald-600 pl-6 py-4 my-8 bg-emerald-50 rounded-r-xl">
                <p class="text-emerald-800 font-medium italic text-lg">"Kehangatan dari dalam jauh lebih awet daripada kehangatan dari jaket tebal."</p>
            </div>

            <h3 class="text-2xl font-bold mb-4 text-black">Senjata Rahasia: Jahe Merah</h3>
            <p class="mb-6">Di jam rawan ngantuk dan kedinginan (biasanya jam 3 sore), hindari es kopi. Ganti dengan minuman yang mengandung <strong>Jahe Merah</strong>.</p>
    ...
    },
    {
        ...
        content: `
            ...
            <div class="border-l-4 border-emerald-600 pl-6 py-4 my-8 bg-emerald-50 rounded-r-xl">
                <p class="text-emerald-800 font-medium italic text-lg">"The perfect gateway drink buat teman kamu yang ngakunya gak suka jamu. Dijamin mereka bakal minta nambah!"</p>
            </div>

            <h3 class="text-2xl font-bold mb-4 text-black">Bahan-bahan</h3>
            <ul class="list-disc list-inside space-y-2 mb-6 ml-2 text-gray-700">
                <li>100ml <strong>GoodRaga Kunyit Asam Fresh</strong> (dingin)</li>
            ...
            <ol class="list-decimal list-inside space-y-3 mb-6 ml-2 text-gray-700">
                <li><strong>Siapkan Gelas Cantik:</strong> Gunakan gelas tinggi (highball). Masukkan es batu hingga gelas hampir penuh.</li>
                <li><strong>Tuang Jamu:</strong> Tuangkan GoodRaga Kunyit Asam perlahan.</li>
                <li><strong>The Fizz:</strong> Tuangkan air soda perlahan-lahan. Aduk pelan sekali saja agar sodanya tidak hilang.</li>
                <li><strong>Aroma Kick:</strong> Masukkan batang sereh sebagai pengaduk alami. Aroma sereh akan keluar perlahan saat diaduk.</li>
                <li><strong>Garnish:</strong> Tambahkan irisan lemon di bibir gelas. Voila!</li>
            </ol>
    ...
    },
    {
        ...
        content: `
            ...
            <p class="mb-6">Sebaliknya, gula aren organik yang dipakai GoodRaga diproses minimal dari nira pohon aren. Karena tidak "dicuci" berlebihan, ia masih mempertahankan mineral bawaan tanah seperti <strong>Kalium, Zat Besi, dan Magnesium</strong>. Warnanya yang cokelat gelap adalah bukti keberadaan mineral dan antioksidan tersebut.</p>
            ...
            <ul class="list-disc list-inside space-y-3 mb-6 ml-2 text-gray-700">
                <li><strong>Gula Pasir:</strong> IG 65-70 (Tinggi). Menyebabkan lonjakan energi cepat, lalu drop cepat (sugar crash).</li>
                <li><strong>Gula Aren:</strong> IG 35-50 (Rendah ke Sedang). Diserap tubuh lebih perlahan, memberikan energi yang lebih stabil.</li>
            </ul>

            <div class="border-l-4 border-emerald-600 pl-6 py-4 my-8 bg-emerald-50 rounded-r-xl">
                <p class="text-emerald-800 font-medium italic text-lg">"Meski lebih baik, gula tetaplah gula. Gula aren lebih aman dan bernutrisi, tapi tetap harus dikonsumsi dalam batas wajar, bukan bebas tanpa batas."</p>
            </div>
            ...
            <p>Itulah kenapa di setiap botol GoodRaga, kami berkomitmen <strong>NO REFINED SUGAR</strong>. Kami hanya menggunakan Gula Aren Organik atau Madu Hutan asli.</p>
        `,
    },
    {
        id: 8,
        ...
        content: `
            ...
            <h3 class="text-2xl font-bold mb-4 text-black">Bahan-bahan</h3>
            <ul class="list-disc list-inside space-y-2 mb-6 ml-2 text-gray-700">
                <li>100ml <strong>GoodRaga Wedang Rempah Calm</strong> (Pati jahenya kuat!)</li>
            ...
            <div class="border-l-4 border-emerald-600 pl-6 py-4 my-8 bg-emerald-50 rounded-r-xl">
                <p class="text-emerald-800 font-medium italic text-lg">"Tips: Jangan merebus susu oat sampai mendidih bergejolak karena bisa merusak teksturnya. Cukup sampai hangat beruap (steaming)."</p>
            </div>

            <h3 class="text-2xl font-bold mb-4 text-black">Langkah Pembuatan</h3>
            <ol class="list-decimal list-inside space-y-3 mb-6 ml-2 text-gray-700">
                <li><strong>Panaskan Susu:</strong> Hangatkan susu oat di panci kecil dengan api sedang. Gunakan pengocok (whisk) untuk membuat sedikit busa di atasnya.</li>
                <li><strong>Campur Jahe:</strong> Tuang GoodRaga Wedang Rempah ke dalam cangkir favoritmu. Jika kamu suka extra panas, bisa dihangatkan sebentar di microwave.</li>
                <li><strong>Satukan:</strong> Tuang susu oat hangat ke dalam cangkir berisi jahe.</li>
                <li><strong>Finishing Touch:</strong> Taburkan bubuk kayu manis di atas busa susu.</li>
            </ol>
    ...
    },
    {
        ...
        content: `
            ...
            <p class="mb-6">Cara kita memulai pagi sangat menentukan ritme sisa hari kita. Jika dimulai dengan reaktif (membalas chat), seharian kita akan merasa diburu. Mari kita ubah dengan ritual <strong>"The First 10 Minutes"</strong>.</p>
            ...
            <div class="border-l-4 border-emerald-600 pl-6 py-4 my-8 bg-emerald-50 rounded-r-xl">
                <p class="text-emerald-800 font-medium italic text-lg">"Merapikan tempat tidur adalah 'kemenangan pertama' (First Win). Ini memberi sinyal ke otak bahwa kamu sudah menyelesaikan satu tugas dengan baik hari ini."</p>
            </div>
...
function generateCardHTML(article, index) {
    ...
    const link = `detail-artikel.html?id=${article.id}`;
    const finalImagePath = resolveImagePath(article.image);

    return `
    <a href="${link}" class="block max-w-[450px] mx-auto break-inside-avoid bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 group cursor-pointer border border-gray/10 animate-fadeIn">
...
document.addEventListener("DOMContentLoaded", () => {
    // 1. Cek apakah kita berada di halaman detail (cek container utama)
    const detailContainer = document.getElementById("article-detail-content");

    if (detailContainer) {
        // 2. Ambil ID dari URL
        const urlParams = new URLSearchParams(window.location.search);
        // Menggunakan parseInt agar aman jika ID di database berupa number
        const articleId = parseInt(urlParams.get("id"));

        // 3. Cari artikel yang cocok di database
        // Asumsi variabel 'articles' sudah tersedia secara global
        const currentArticle = articles.find((item) => item.id === articleId);

        if (currentArticle) {
            // =========================================
            // BAGIAN 1: UPDATE JUDUL (Request Anda)
            // =========================================
            const newTitle = `${currentArticle.title} — GoodRaga`;

            // Cara A: Update Tab Browser
            document.title = newTitle;

            // Cara B: Update elemen <title id="page-title">
            ...
            // =========================================
            // BAGIAN 2: UPDATE KONTEN UTAMA
            // =========================================
            // Helper function untuk aman set text (mencegah error jika elemen null)
            ...
            // Update Body (innerHTML karena mungkin ada tag <p> atau <b>)
            ...
            if (imgEl) {
                // Gunakan resolveImagePath jika Anda memilikinya, jika tidak pakai currentArticle.image langsung
                imgEl.src =
                    typeof resolveImagePath === "function"
                        ? resolveImagePath(currentArticle.image)
                        : currentArticle.image;
                imgEl.alt = currentArticle.title;
            }

            // =========================================
            // BAGIAN 3: UPDATE SIDEBAR (Artikel Lainnya)
            // =========================================
            const sidebarContainer =
                document.getElementById("sidebar-articles");
            if (sidebarContainer) {
                // Ambil 3 artikel selain yang sedang dibuka
                ...
                sidebarContainer.innerHTML = otherArticles
                    .map((a) => {
                        const imgPath =
                            typeof resolveImagePath === "function"
                                ? resolveImagePath(a.image)
                                : a.image;

                        return `
                    <li class="group">
                        <a href="detail-artikel.html?id=${a.id}" class="flex gap-3 items-start">
                            ...
                            <div>
                                <h5 class="text-sm font-bold text-gray-900 group-hover:text-emerald-600 transition line-clamp-2 leading-snug">
                                    ${a.title}
                                </h5>
                                <span class="text-[10px] text-gray-400 mt-1 block">${a.date}</span>
                            </div>
                        </a>
                    </li>
                    `;
            ...
            const titleElement = document.getElementById("page-title");
            if (titleElement)
                titleElement.innerText = "Artikel Tidak Ditemukan — GoodRaga";
            ...
            detailContainer.innerHTML = `
                <div class="text-center py-20 flex flex-col items-center justify-center min-h-[50vh]">
                    ...
                    <h2 class="text-2xl font-bold text-gray-800">Artikel tidak ditemukan</h2>
                    <p class="text-gray-500 mt-2">Mungkin link yang kamu tuju sudah kadaluarsa atau salah ketik.</p>
                    <a href="artikel.html" class="mt-6 px-6 py-2 bg-emerald-600 text-white rounded-full hover:bg-emerald-700 transition shadow-lg hover:shadow-xl">
                        Kembali ke Journal
                    </a>
                </div>
            `;

            // Sembunyikan Sidebar jika artikel utama tidak ada (Opsional, agar lebih rapi)
