...
if (mainContainer) {
    mainContainer.innerHTML = rawMaterials.map(section => {
        ...
        return `
            <section class="reveal translate-y-10 opacity-0 transition-all duration-1000">
                <div class="mb-8 border-l-4 border-emerald-500 pl-4">
                    <h2 class="text-sm font-bold uppercase tracking-widest text-neutral-500 mb-1">
                        KATEGORI <span class="${section.color}">${section.category}</span>
                    </h2>
                    <p class="text-neutral-400 text-sm italic">${section.desc}</p>
                </div>
